# Generated by Django 3.2.6 on 2021-09-11 08:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TienLuong', models.DecimalField(decimal_places=2, default=None, max_digits=8, null=True)),
                ('DiemUyTin', models.FloatField(null=True)),
                ('ThuViec', models.BooleanField(default=False, null=True)),
                ('ChuyenDaLai', models.IntegerField(default=0, null=True)),
                ('DoThanThiet', models.IntegerField(default=0, null=True)),
                ('SoVeDaDat', models.IntegerField(default=0, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TaiXe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NguoiDung', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='chuyen',
            name='Tuyen',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='quanly.tuyen'),
        ),
        migrations.AddField(
            model_name='chuyen',
            name='Xe',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='quanly.xe'),
        ),
        migrations.CreateModel(
            name='ChiTieu',
            fields=[
                ...
                ('NhanVienBanVe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ChiTieuNhanVien', to=settings.AUTH_USER_MODEL)),
                ('TaiXe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ChiTieuTaiXe', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='BenXe',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='quanly.benxe'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
