    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('GiaTien', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('NoiDen', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TuyenDen', to='quanly.benxe')),
                ('NoiKhoiHanh', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TuyenKhoiHanh', to='quanly.benxe')),
            ],
            options={
